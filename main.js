...
function mostrarProductos(array)
{
    ...
    `;
    // const botonCarrito =document.getElementById(items.id);      //analiza la presion de los botones de los productos
    // botonCarrito.addEventListener("click",AgregarAlCarrito(items));
    // }
}
//botones del menu lateral
let botonAuriculares = document.getElementById("menuAuriculares");
botonAuriculares.addEventListener("click",()=>{
    pagina="auriculares";
    mostrarProductos(auriculares);
});
let botonAccesorios = document.getElementById("menuAccesorios");
botonAccesorios.addEventListener("click",()=>{
    mostrarProductos(accesorios);
    pagina="accesorios";
});
let botonTelefonos = document.getElementById("menuTelefonos");
botonTelefonos.addEventListener("click",()=>{
    mostrarProductos(telefonos);
    pagina="telefonos";
});

//botones de compra
const botonCarrito =document.getElementById("A001");            //analiza la presion de los botones de los productos
botonCarrito.addEventListener("click", AgregarAlCarrito(todosLosProductos[0]));
}
